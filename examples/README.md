...
Examples require the daemon to already be running; they do not spawn or supervise Onlyne. Telegram/Weixin Markdown tables are split out and rendered to PNG with Rust `resvg`; Feishu keeps tables inside the interactive card.
