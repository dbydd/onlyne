...
// clippy::collapsible_if: this reducer stays byte-comparable to its vendor source.
...
// clippy::if_same_then_else: this reducer stays byte-comparable to its vendor source.
...
mod tests {
    ...
    // clippy::redundant_closure: this test stays byte-comparable to its vendor source.
