 ...
 * claims that scoped the tab axis, and that authority now rides the session axis
 * instead; the key stays because the committed `panel.html` is generated
 * byte-for-byte from the placeholder render of this function, and the working
 * copy of that file belongs to a dev install.
 */
