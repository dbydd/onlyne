...
Counts come from `cargo test --workspace` on 2026-09-11 (502 passed, 0 failed), one line per crate with its libraries and integration targets summed.
